...
export const critierios = [
  "se definio la mision",
  "Se definieron y conocen restricciones",
  "Se establecieron mecanismos de crecimiento",
  "Se definio la composicion",
  "Se bosquejaron responsabilidades",
  "Se declaro nivel de compromiso requerido",
  "Se identificaron competencias requeridas",
  "Se determino el tamaño",
  "Se definieron reglas de gobierno",
  "Se selecciono modelo de liderazgo",
];

export const EjecutandoCard = () => {
  ...
  return (
    <CardAlpha title={"equipo"} type={"gestion"}>
      <div className={styles.statecard__container}>
        <h2
          className={styles.statecard__title}
          style={{ border: "3px solid #4C6FC6" }}
        >
          Ejecutando
        </h2>
        ...
        <div
          ...
          style={{ border: "3px solid #4C6FC6", backgroundColor: "#C6D9F1" }}
        >
